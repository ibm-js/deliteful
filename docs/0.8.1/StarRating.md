...
This widget has no specific security concern. Refer to [`delite/FormValueWidget`](/delite/docs/0.8.1/FormValueWidget.html) documentation for general security advice on this base class.
