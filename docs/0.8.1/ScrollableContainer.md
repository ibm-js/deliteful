...
[`delite/Scrollable`](/delite/docs/0.8.1/Scrollable.html).
...
For details, see [`Using delite/Scrollable`](/delite/docs/0.8.1/Scrollable.html#using).

### Programmatic Scroll

In additional to the interactive scroll, the API of `deliteful/ScrollableContainer` provides methods 
for programmatic scroll. For details, see [`Using delite/Scrollable`](/delite/docs/0.8.1/Scrollable.html#using).
...
For details, see [`Events in delite/Scrollable`](/delite/docs/0.8.1/Scrollable.html#events).
...
(see [`Element Styling in delite/Scrollable`](/delite/docs/0.8.1/Scrollable.html#styling), 
...
responsive manner. For details, see [`Interactions in delite/Scrollable`](/delite/docs/0.8.1/Scrollable.html#interactions).
...
For details, see 
[`Enterprise Use of delite/Scrollable`](/delite/docs/0.8.1/Scrollable.html#interactions).
