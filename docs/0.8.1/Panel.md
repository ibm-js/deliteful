...
* `closedIconClass`: this CSS class is only used when the panel is inside a [`deliteful/Accordion`](/deliteful/docs/0.8.1/Accordion.html)
...
For more informations, see [`delite/Container`](/delite/docs/0.8.1/Container.html) documentation.
