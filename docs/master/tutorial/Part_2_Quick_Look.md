...
In the [first step](Part_1_Getting_Started.html) of this tutorial we have setup the tools and created a first deliteful
...
let's move to the [next step](Part_3_Photo_Feed_App.html) where we will describe the application that we will create.

[Previous Step - Getting Started with Deliteful](Part_1_Getting_Started.html)

[Next Step - Introducing the Photo Feed Application](Part_3_Photo_Feed_App.html)
