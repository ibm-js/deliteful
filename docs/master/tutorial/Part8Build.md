...
We finished the development part of our example by adding a [settings view](Part7SettingsView.html).
...
In the [first step](Part1GettingStarted.html) of the tutorial we chose to use the source versions of the dependency
...
[Previous Step - The Settings View](Part7SettingsView.html)
