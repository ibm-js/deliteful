...
Our example app is almost complete now that we added the [details view](Part_6_Details_View.html).
...
[Previous Step - Adding a Details View](Part_6_Details_View.html)
