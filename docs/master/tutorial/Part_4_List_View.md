...
We will now begin to create our [Flickr photo feed viewer application](Part_3_Photo_Feed_App.html).
...
[next step](Part_5_Custom_Renderer.html), we will further customize our list view to enhance the display.

[Previous Step - Introducing the Photo Feed Application](Part_3_Photo_Feed_App.html)

[Next Step - Enhancing the List View](Part_5_Custom_Renderer.html)
