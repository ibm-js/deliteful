...
For more informations, see the [`delite/DisplayContainer`](/delite/docs/0.8.0/DisplayContainer.html) documentation.
...
This widget has no specific security concern. Refer to [`delite/Widget`](/delite/docs/0.8.0/Widget.html) for general security advice on this base class that `deliteful/ResponsiveColumns` is using.
