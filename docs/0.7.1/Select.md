...
For details, see [`Using delite/Selection`](/delite/docs/0.7.1/Selection.html#using).
...
Because the widget inherits from [`delite/StoreMap`](/delite/docs/0.7.1/StoreMap.html), 
...
[`delite/StoreMap`](/delite/docs/0.7.1/StoreMap.html) documentation for more
