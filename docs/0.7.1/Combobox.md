...
selection mode, `selectedItems`) inherited from [`delite/Selection`](/delite/docs/0.7.1/Selection.html).
...
See the [`delite/StoreMap`](/delite/docs/0.7.1/StoreMap.html) documentation for
...
and `alt`, inherited from [`delite/FormWidget`](/delite/docs/0.7.1/FormWidget.html), and
`readOnly` inherited from [`delite/FormValueWidget`](/delite/docs/0.7.1/FormValueWidget.html).
