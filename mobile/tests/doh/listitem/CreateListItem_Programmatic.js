dojo.addOnLoad(function(){
	...
	demoWidget = new dojox.mobile.ListItem({icon:"../../images/i-icon-1.png", rightIcon:"duiDomButtonBluePlus", label:"XX Widget"});
	list.addChild(demoWidget);

	demoWidget = new dojox.mobile.ListItem({icon:"../../images/i-icon-2.png", rightIcon:"duiDomButtonRedMinus", label:"YY Widget"});
	list.addChild(demoWidget);

	list = dijit.byId("dojox_mobile_EdgeToEdgeList_1");
	demoWidget = new dojox.mobile.ListItem({rightIcon:"duiDomButtonCheckboxOff", variableHeight:"true"});
	...
	demoWidget = new dojox.mobile.ListItem({rightIcon:"duiDomButtonCheckboxOn", variableHeight:"true"});
