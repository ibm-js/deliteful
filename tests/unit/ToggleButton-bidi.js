define([
	...
	var container, html = "<button is='d-toggle-button' id='b1' textDir='ltr' checkedLabel='ABC \u05d0\u05d1\u05d2'>\u05d0\u05d1\u05d2 ABC</button>" +
		...
		"<button is='d-toggle-button' id='b3' title='ABC \u05d0\u05d1\u05d2' textDir='auto' checkedLabel='ABC \u05d2\u05d1\u05d0'>\u05d0\u05d1\u05d2 ABC</button>" +
		"<button is='d-toggle-button' id='b4' label='ABC \u05d2\u05d1\u05d0' textDir='auto' checkedLabel = '\u05d0\u05d1\u05d2 ABC' checked = 'true'></button>";

	registerSuite ({
		name: "deliteful/ToggleButton (bidi): markup",
		setup: function () {
	...
	registerSuite ({
		...
		"textDir": function () {
			...
			moduleRequire(["delite/register", "deliteful/ToggleButton"], dfd.callback(function (register, ToggleButton) {
				var b1 = new ToggleButton({id: "b1", label: "\u05d0\u05d1\u05d2 ABC", title: "ABC \u05d0\u05d1\u05d2", checkedLabel: "ABC \u05d2\u05d1\u05d0"});
				...
				b1.checked = true;
				b1.deliver();
				assert.strictEqual("\u202aABC \u05d2\u05d1\u05d0\u202c", b1.labelNode.textContent, "ltr: wrong default value for 'checkedLabel'");
				b1.textDir = "rtl";
				b1.deliver();
				assert.strictEqual("\u202bABC \u05d2\u05d1\u05d0\u202c", b1.labelNode.textContent, "rtl: wrong displayed value for 'checkedLabel'");
				...
				b1.checked = true;
				b1.deliver();
				assert.strictEqual("\u202aABC \u05d2\u05d1\u05d0\u202c", b1.labelNode.textContent, "auto: wrong default value for 'checkedLabel'");				
			}));
		},
		...
		"checkedLabel": function () {
			...
			moduleRequire(["delite/register", "deliteful/ToggleButton"], dfd.callback(function (register, ToggleButton) {
				...
				b2.deliver();
				assert.strictEqual("\u202bABC \u05d0\u05d1\u05d2\u202c", b2.labelNode.textContent, "checkedLabel: wrong displayed rtl value");
				b2.textDir = "ltr";
