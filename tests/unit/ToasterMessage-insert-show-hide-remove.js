define([
	...
	registerSuite({
		...
		"Testing insert in Dom": function () {
			...
			assert.isTrue(classList.hasClass(mExpirable, toaster.animationInitialClass));
			...
			assert.isTrue(classList.hasClass(mPersistent, toaster.animationInitialClass));
		...
		"Testing show in Dom": function () {
			...
			setTimeout(function () {
				assert.isTrue(classList.hasClass(mPersistent, toaster.animationEnterClass));
				d.resolve();
		...
		"Testing hide in Dom": function () {
			...
			assert.isTrue(classList.hasClass(mExpirable, toaster.animationQuitClass));
		...
		"Testing remove in Dom": function () {
			...
			assert.isTrue(classList.hasClass(mExpirable, toaster.animationEndClass));
