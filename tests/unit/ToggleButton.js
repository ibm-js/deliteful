define(function (require) {
	...
	var commonSuite = {
		tests: {
			"Default State": function () {
				...
				assert.isTrue(/ic2/.test(tb.iconNode.className),
					"Missing icon css class on iconNode (checkedIconClass).");
			},
	...
	registerSuite("deliteful/ToggleButton: markup", markupSuite);
	...
	registerSuite("deliteful/ToggleButton: programmatic", programmaticSuite);
});
