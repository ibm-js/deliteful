				...
				tests: {
					...
					"HOME and END keys": function () {
						return this.remote
							...
							.execute(function () {
								return document.activeElement.querySelector(".d-label").textContent;
							}).then(function (v) {
					...
					"Ctrl - PageUp / PageDown": function () {
						if (/^(internet explorer|chrome)$/i.test(this.remote.environmentType.browserName)) {
