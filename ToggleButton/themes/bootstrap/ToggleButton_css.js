...
.d-toggle-button-styles:focus,\
.d-toggle-button-styles:active:focus,\
.d-toggle-button-styles.active:focus {\
  outline: thin dotted;\
  outline: 5px auto -webkit-focus-ring-color;\
  outline-offset: -2px;\
}\
.d-toggle-button-styles:hover,\
.d-toggle-button-styles:focus {\
  color: #333333;\
  text-decoration: none;\
}\
.d-toggle-button-styles:active,\
.d-toggle-button-styles.active {\
  outline: 0;\
  background-image: none;\
  -webkit-box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);\
...
.d-toggle-button-styles.disabled,\
.d-toggle-button-styles[disabled],\
fieldset[disabled] .d-toggle-button-styles {\
  cursor: not-allowed;\
  opacity: .65;\
  -webkit-box-shadow: none;\
  -moz-box-shadow: none;\
...
.d-toggle-button-styles.disabled,\
.d-toggle-button-styles[disabled],\
.d-toggle-button-styles.disabled:hover,\
.d-toggle-button-styles[disabled]:hover,\
.d-toggle-button-styles.disabled:focus,\
.d-toggle-button-styles[disabled]:focus,\
.d-toggle-button-styles.disabled:active,\
.d-toggle-button-styles[disabled]:active,\
.d-toggle-button-styles.disabled.active,\
.d-toggle-button-styles[disabled].active {\
  background-color: #ffffff;\
...
.d-toggle-button.disabled,\
.d-toggle-button[disabled],\
fieldset[disabled] .d-toggle-button {\
  cursor: not-allowed;\
  opacity: .65;\
  -webkit-box-shadow: none;\
  -moz-box-shadow: none;\
...
.d-toggle-button.disabled,\
.d-toggle-button[disabled],\
.d-toggle-button.disabled:hover,\
.d-toggle-button[disabled]:hover,\
.d-toggle-button.disabled:focus,\
.d-toggle-button[disabled]:focus,\
.d-toggle-button.disabled:active,\
.d-toggle-button[disabled]:active,\
.d-toggle-button.disabled.active,\
.d-toggle-button[disabled].active {\
  background-color: #ffffff;\
...
.d-toggle-button.d-checked span {\
  border: inset 3px transparent;\
  margin: 0px;\
}";
});
