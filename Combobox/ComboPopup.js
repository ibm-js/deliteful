...
import ComboboxImplementation from "./ComboboxImplementation";
import template from "delite/handlebars!./ComboPopup.html";
...
export default register("d-combo-popup", [ HTMLElement, ComboboxImplementation ], /** @lends module:deliteful/Combobox/ComboPopup# */ {
	...
	focus: function () {
		if (this.autoFilter && this.selectionMode === "single") {
			...
			var renderer = (id && id !== -1) ? this.getRendererByItemId(id) :
